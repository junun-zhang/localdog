...
- [x] 法定节假日 + 传统节日 + 调休标识
- [x] 寒暑假校历数据 (2025-2028内置)

## Phase 7: 天气集成 (100% ✅)
- [x] 天气Widget (WeatherCard/WeatherCompact可复用组件)
- [x] 日/周视图天气显示 (模拟数据, 可替换为API)

## Phase 8: 提醒引擎 (100% ✅)
- [x] AlarmManager定时 (ReminderManager)
- [x] 通知UI (NotificationChannel + BroadcastReceiver)
- [x] 通知操作(点击打开事件)
